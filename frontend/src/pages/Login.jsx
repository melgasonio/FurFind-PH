        ...
        <div className={isNavOpen ? 'hidden' : 'font-lato'}>
            <BodyContainer className='h-screen flex flex-col'>
                <div className='bg-coral-700 px-[var(--size-xsm)] pt-[72px] pb-[120px] flex-grow flex flex-col gap-[8px] justify-center'>
                    <form className="bg-white-200 flex flex-col gap-[var(--size-xsm)] px-[var(--size-xsm)] py-[var(--size-sm)] rounded-[2.5px] text-black-400" onSubmit={handleLogin}>
                        <h3 className='text-center text-black-700 font-semibold'>Login</h3>
                        <div className="flex flex-col text-black-500 text-[12px] gap-[8px] mb-[24px]">
